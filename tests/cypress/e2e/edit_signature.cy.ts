...
describe.skip("PRONOM Edit Signature Spec", () => {
  ...
  it("renders the edit signature form", () => {
    ...
    const expectedIdentifiers = [
      { type: "MIME", value: "application/vnd.Quark.QuarkXPress" },
      { type: "PUID", value: "fmt/2008" },
    ];
    checkTables("identifier", expectedIdentifiers);
    const expectedRelationships = [
      { type: "Has priority over", value: "x-fmt/182" },
      { type: "Is subsequent version of", value: "fmt/2007" },
    ];
