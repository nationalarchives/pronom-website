...
The website is hosted in AWS, using serverless technologies. Most of the website is static content, refreshed when a new release is made. To support search and the legacy SOAP API for DROID, there are a small number of AWS Lambda Functions, with API Gateway handling the SOAP endpoint and CloudFront serving the website.
...
Requests to this Lambda Function are routed through API Gateway, which handles the SOAP endpoint traffic for the website.
